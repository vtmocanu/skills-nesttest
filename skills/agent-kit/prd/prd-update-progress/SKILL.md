...
> Vendored from [vfarcic/dot-ai](https://github.com/vfarcic/dot-ai) `shared-prompts/prd-update-progress.md` (MIT, Copyright (c) 2025 Viktor Farcic). Original author: Viktor Farcic.
